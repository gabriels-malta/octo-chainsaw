...
namespace TechCase.Services.Worker.AccountDiscovery
{
    class Program
    {
        ...
        static Task Main(string[] args)
        {
            ...
            try
            {
                Log.Information("Worker TechCase.Services.Worker.AccountDiscovery started at {DateTime}", DateTime.UtcNow);
                ...
                var consumer = new Consumer(_accountRepository, _publisher, _httpClient, _quitEvent, Log.Logger);
            ...
            {
                Log.Fatal(ex, "TechCase.Services.Worker.AccountDiscovery crashed!");
                throw;
            }
        }
