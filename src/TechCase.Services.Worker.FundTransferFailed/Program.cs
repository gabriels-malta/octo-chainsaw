...
namespace TechCase.Services.Worker.FundTransferFailed
{
    class Program
    {
        ...
        static Task Main(string[] args)
        {
            ...
            try
            {
                Log.Information("Worker TechCase.Services.Worker.FundTransferFailed started at {DateTime}", DateTime.UtcNow);
                ...
                var consumer = new Consumer(_transferRepository, _quitEvent, Log.Logger);
            ...
            {
                Log.Fatal(ex, "TechCase.Services.Worker.FundTransferFailed crashed!");
                throw;
            }
        }
